...
/*
        ...
        //add work tips
        tips.add(new Tip("Compliments can be a great way to open the door to a conversation. Offer a co-worker a compliment on a presentation he gave at a meeting or compliment your neighbor on his new car.",2,1));
        tips.add(new Tip("Empathy is especially important when dealing with clients who come to you with questions or problems. You need to express genuine concern for their issues, and help solve them.",2,2));
        tips.add(new Tip("Cooperation is especially important when you work on a team. You need to be able to work with others to reach a common goal. However, even if you do not work on a team, cooperation is still important. You need to be able to work alongside colleagues to help achieve the goals of your organization.",2,3));
        tips.add(new Tip("Verbal communication is an extremely important social skill in every job. You need to express yourself using clear language that others can understand. You need to be able to speak in person, on the phone, and via email with others.",2,4));

        // add romantic tips
        tips.add(new Tip("Get a Hobby: The adage, “If you cultivate an interest, people will find you interesting” really is true. Get yourself involved in something that will get you out the door and engaged while broadening your social circle. Take a cooking class, sign up for language lessons, learn to skate or join a book club. Hobbies also provide handy conversational fodder for first dates.",3,1));
        tips.add(new Tip("Volunteer. It doesn’t matter what you do (dog walking at the local shelter, serving soup at the homeless kitchen). Volunteering will put you in the path of like-minded people with good hearts and a strong sense of community",3,7));
        tips.add(new Tip("People often say \"you never get a second chance to make a first impression\", and that's actually quite true—which is why it's so important to start on the right foot.",3,6));
        tips.add(new Tip("On a date, make sure you don’t do all the talking. Try to keep what you have to say short and concise. You don’t want to start boring your date. If this date goes well, there will be lots more opportunities to share your stories in the future. ",3,3));
        tips.add(new Tip("Talking about your ex is dangerous territory. It’s best to stay away from the conversation altogether. Your date will not be interested and it can make things feel awkward between you. If your date does bring up the subject, try to keep answers short (without appearing suspicious).",3,2));

        String tipSave = gson.toJson(tips);
        ...
        if(file.exists()){
            ...
            tip1.setText(ranking.getTip1());
            tip2.setText(ranking.getTip2());
            tip3.setText(ranking.getTip3());
            tip4.setText(ranking.getTip4());
        }
        else{
